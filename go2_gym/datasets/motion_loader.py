...
class MotionLoader:
    ...
    def __init__(self, device, motion_file=None, corruption_level=0.0, reference_observation_horizon=2, test_mode=False, test_observation_dim=None):
        ...
        if motion_file is None:
            motion_file = MINI_GYM_ROOT_DIR + "/resources/robots/anymal_c/datasets/motion_data.pt"
        print("LEGGED_GYM_ROOT_DIR:-------",MINI_GYM_ROOT_DIR)
        #self.reference_state_idx_dict_file = os.path.join(os.path.dirname(motion_file), "reference_state_idx_dict.json")
        self.reference_state_idx_dict_file = MINI_GYM_ROOT_DIR + "/resources/robots/go2/datasets/reference_state_idx_dict.json"
